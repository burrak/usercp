...
class LoginHandler {
   ...
   protected function hashPassword($login, $heslo) {
   ...
   protected function checkPassword($login, $heslo, $heslo_hash) {
   ...
   public function checkLogin() {
      ...
      if (!isset($loginDb['id'])) {
         return array('view_content' => 'registrace', 'view_alert' => 'error', 'alert' => 'Uživatelské jméno neexistuje');
      }
      ...
      if ($passCheck == 'TRUE') {
         ...
         return array('view_content' => 'registrace', 'view_alert' => 'error', 'alert' => 'Špatné heslo');
      }
   }
